 ...
 */
class TypeCompte extends \TypeCompte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TypeCompte' . "\0" . 'id', '' . "\0" . 'TypeCompte' . "\0" . 'libelle', '' . "\0" . 'TypeCompte' . "\0" . 'comptes'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeCompte $proxy) {
