...
class Client extends \Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Client' . "\0" . 'id', '' . "\0" . 'Client' . "\0" . 'email', '' . "\0" . 'Client' . "\0" . 'adresse', '' . "\0" . 'Client' . "\0" . 'telephone', '' . "\0" . 'Client' . "\0" . 'nom', '' . "\0" . 'Client' . "\0" . 'prenom', '' . "\0" . 'Client' . "\0" . 'salaire', '' . "\0" . 'Client' . "\0" . 'nomEntreprise', '' . "\0" . 'Client' . "\0" . 'employeur', '' . "\0" . 'Client' . "\0" . 'typeClient', '' . "\0" . 'Client' . "\0" . 'comptes'];
        }
